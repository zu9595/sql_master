...
insert into reply (reply_no, board_no, reply, replyer, reply_date)
values(reply_seq.nextval, 3, '하하', '홍길동', to_date(sysdate, 'YY-MM-DD'));

insert into reply (reply_no, board_no, reply, replyer, reply_date)
values(reply_seq.nextval, 3, '하하하', '홍길동', to_date(sysdate, 'YY-MM-DD'));

insert into reply (reply_no, board_no, reply, replyer, reply_date)
values(reply_seq.nextval, 3, '하하하하', '홍길동', to_date(sysdate, 'YY-MM-DD'));
